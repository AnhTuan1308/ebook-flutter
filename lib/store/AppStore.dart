...
// VietJet observable
 ...
 @observable
  String VietJetuserId = "";

 @observable
  String VietJetusername = "";

 @observable
  String VietJetfullName = "";

 @observable
  String VietJetsysToken = "";

 @observable
  int VietJetsysTokenExpires = 0;

 @observable
  String VietJetvolToken = "";

 @observable
  int VietJetvolTokenExpires = 0;

 @observable
  String VietJetrefreshToken = "";

 @observable
  int VietJetrefreshTokenExpires = 0;

 @observable
  List<String> VietJetroles =  <String>[].asObservable();

 @observable
  List<String> VietJetpermisssions = <String>[].asObservable();
...
// VietJet AppStore
  ...
  @action
  Future<void> setVietJetUserId(String value) async {
    VietJetuserId = value;
    await setValue(VIETJET_USER_ID, value);
  }
  @action
  Future<void> setVietJetUserName(String value) async {
    VietJetusername = value;
    await setValue(VIETJET_USER_NAME, value);
  }
  @action
  Future<void> setVietJetFullName(String value) async {
    VietJetfullName = value;
    await setValue(VIETJET_FULL_NAME, value);
  }
  @action
  Future<void> setVietJetSysToken(String value) async {
    VietJetsysToken = value;
    await setValue(VIETJET_TOKEN, value);
  }
  @action
  Future<void> setVietJetSysTokenExpires(int value) async {
    VietJetsysTokenExpires = value;
    await setValue(VIETJET_TOKEN_EXPIRES, value);
  }
  @action
  Future<void> setVietJetVolToken(String value) async {
    VietJetvolToken = value;
    await setValue(VIETJET_VOL_TOKEN, value);
  }
  @action
  Future<void> setVietJetVolTokenExpires(int value) async {
    VietJetvolTokenExpires = value;
    await setValue(VIETJET_VOL_TOKEN_EXPIRES, value);
  }
  @action
  Future<void> setVietJetRefreshToken(String value) async {
    VietJetrefreshToken = value;
    await setValue(VIETJET_REFRESH_TOKEN, value);
  }
  @action
  Future<void> setVietJetRefreshTokenExpires(int value) async {
    VietJetrefreshTokenExpires = value;
    await setValue(VIETJET_REFRESH_TOKEN_EXPIRES, value);
  }
  @action
  Future<void> setVietJetRoles(List<String> value) async {
    VietJetroles = value;
    await setValue(VIETJET_ROLES, value);
  }
  @action
  Future<void> setVietJetPermisssions(List<String> value) async {
    VietJetpermisssions = value;
    await setValue(VIETJET_PERMISSSIONS, value);
  }
