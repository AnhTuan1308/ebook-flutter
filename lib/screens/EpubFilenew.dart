...
class ViewEPubFileNewState extends State<ViewEPubFileNew> {
  ...
  Future<void> downloadFile() async {
      var url = "https://api.library.hexonteam.tech/api/books/${widget.mBookId}/file?consumer_key=ck_e705e5faaccec614e7d5a8574513bccda31821f0&consumer_secret=cs_d79889e6f6c7d2ba17afc43677ba923f58941a76";
    await InternetFile.get(
       url,
       headers: {
      HttpHeaders.contentTypeHeader: 'application/json; charset=utf-8',
      HttpHeaders.cacheControlHeader: 'no-cache',
      HttpHeaders.authorizationHeader :'Bearer ${appStore.VietJetvolToken}'
       },
      storage: storageIO,
          ...
          floatingActionButton: Container(
            ...
            if (!widget.isPDFFile) {
              ...
              if (v != null) {
                ...
                appStore.setPage(v - 1);
                await pdf.setPage(v - 1);
                setState(() {});
              }
            }
          }),
