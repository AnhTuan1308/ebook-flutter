  ...
  Future<void> getBookDetails({afterPayment = false}) async {
    ...
    await isNetworkAvailable().then((bool) async {
      ...
      if (bool) {
        ...
        // };
        await getBookDetailsRestApi(widget.mBookId).then((res) async {
          ...
          BookResponse bookInfo = BookResponse.fromJson(res);
            mBookDetailsData = bookInfo.bookdetail!;
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return DownloadFilesView(
                        widget.mBookId,
                        viewFiles[index],
                        mBookDetailsData.thumbnailUrl,
                        mBookDetailsData.title,
                            ...
                            children: [
                              Observer(
                                builder: (_) => TextButton(
                                  ...
                                  child: Text(
                                    !appStore.isAddToCart ? keyString(context, 'lbl_my_library')!.toUpperCase() : keyString(context, 'lbl_borrow_digital_book')!.toUpperCase(),
                              ...
                              TextButton(
                                ...
                                child: Text(
                                  keyString(context, 'lbl_borrow_physical_book')!.toUpperCase(),
                                  style: primaryTextStyle(color: white),
                                ),
                              ),
                            ],
