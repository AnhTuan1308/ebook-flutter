...
class _AuthorDetailsState extends State<AuthorDetails> {
  ...
  Future getAuthorList() async {
    await isNetworkAvailable().then((bool) async {
      if (bool) {
        await getVietJetAuthorBookListRestApi(widget.authorDetails!.id).then(
          (res) async {
            appStore.setLoading(false);
            DashboardResponse dashboardResponse = DashboardResponse.fromJson(res);
            mAuthorBookList = dashboardResponse.data;
            setState(() {});
          },
        ).catchError(
          (onError) {
              ...
              sliver: SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: AuthorDetailsHeaderComponent(
                    ...
                    url: "https://secure.gravatar.com/avatar/4e838b59bfff152199fcc9bc3b4aa02e?s=96&d=mm&r=g",
                  ),
                ),
              ),
            ),
                    ...
                    : Column(
                        ...
                        children: [
                          Align(
                            ...
                            child: Text('${widget.authorDetails!.bio!}', style: primaryTextStyle(), maxLines: 10),
                          ).paddingOnly(left: 16, right: 16, top: 16).visible(widget.authorDetails!.bio!.validate().isNotEmpty),
                          16.height.visible(widget.authorDetails!.bio!.validate().isNotEmpty),
                          16.height,
                          AnimationLimiter(
