          ...
          BookResponse bookInfo = BookResponse.fromJson(res);
            mBookDetailsData = bookInfo.bookdetail!;
              ...
              mSampleFile = "ContainsDownloadFiles";
                ...
                dv.id = "1";
                dv.name = "${mBookDetailsData!.title!}";
                dv.file = "/${mBookDetailsData!.title}.pdf";
                          ...
                          Stack(
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () async {
                                  if (appStore.isLoggedIn) {
                                    Map? res = await MyCartScreen().launch(context);
                                    log(res);
                                    print(res);
                                    if (res != null) {
                                ...
                                icon: Icon(Icons.request_page_outlined, color: appStore.iconColor),
                              ),
                              Container(
